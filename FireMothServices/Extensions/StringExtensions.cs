...
/// <summary>Contains extension methods for <see cref="string"/> objects.</summary>
public static class StringExtensions
{
    /// <summary>Returns <c>true</c> if the provided string is empty or contains only whitespace
    /// characters.</summary>
    /// <param name="value">The string to check.</param>
    /// <returns><c>true</c> if the provided string is empty or contains only whitespace.</returns>
    public static bool IsEmptyOrWhiteSpace(this string value) =>
        value.All(char.IsWhiteSpace);

    /// <summary>Returns <c>true</c> if the provided string is a valid base 64 string.</summary>
    /// <param name="value">The string to check.</param>
