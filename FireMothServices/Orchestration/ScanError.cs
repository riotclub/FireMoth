...
/// <summary>Represents an error that occured during a file scan.</summary>
public class ScanError
{
    /// <summary>Initializes a new instance of the <see cref="ScanError"/> class.</summary>
    /// <param name="path">The path to the file or directory that this error pertains to.</param>
    ...
    /// <summary>Gets the path to the file or directory related to this error.</summary>
    public string? Path { get; }

    /// <summary>Gets the message describing this error.</summary>
    public string Message { get; }

    /// <summary>Gets the exception related to this error.</summary>
