...
public sealed class SHA256Analyzer : RiotClub.FireMoth.Services.DataAnalysis.IAnalyzer, IDisposable
{
    ...
    public SHA256Analyzer()
    {
        _hashAlgorithm = SHA256.Create();
    }

    public AnalysisResult<IAnalyzer> AnalyzeFromStream(Stream inputStream)
    {
        throw new NotImplementedException();
    }
    
    public AnalysisResult<SHA256Analyzer> AnalyzeFromStream(Stream inputStream)
    {
        ...
        var hashAnalysisResult = new AnalysisResult<SHA256Analyzer>(_hashAlgorithm.Hash);
